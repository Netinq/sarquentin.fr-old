<section id="tarifs" class="row">
    <div class="hide">
            ...
            <div class="pr">
                ...
                <div class="list">
                    ...
                    <div class="elem">
                        ...
                        <p>Maintenance<span class="option">(14 jours inclus)</span></p>
                    </div>
                </div>
                <a href="#devis">
                    <div class="devis">
        ...
        <div class="txt col-12 col-sm-10 col-xl-6 offset-sm-1 offset-xl-3">
            <h2>Gamme web semi</h2>
            <p>Nous vous proposons une gamme d'offre adapté si vous avez déjà une partie du site réalisé.</p>
        </div>
        <div class="pr-ct col-lg-12 col-xl-10 offset-xl-1">
            <div class="pr">
                <div class="head">
                    <h3>Web Design</h3>
                    <p>Création d'un design pour votre site.</p>
                </div>
                <div class="price">
                    <span>à partir de</span>
                    <p>100€</p>
            ...
            <div class="pr">
                <div class="head">
                    <h3>front-end</h3>
                    <p>Intégration à partir d'un web design.</p>
                </div>
                <div class="price">
                    <span>à partir de</span>
                    <p>200€</p>
                ...
                <div class="list">
                    <div class="elem">
                        <img src="{{asset('images/svg/check-yellow.svg')}}" alt="Check icon">
                        <p>Développement HTML, CSS, JS</p>
                    </div>
                    <div class="elem">
                        <img src="{{asset('images/svg/check-yellow.svg')}}" alt="Check icon">
                        <p>Animations CSS & JavaScript</p>
                    </div>
                </div>
                <a href="#devis">
                    <div class="devis">
            ...
            <div class="pr">
                <div class="head">
                    <h3>back-end</h3>
                    <p>Intégration à votre site front-end.</p>
                </div>
                <div class="price">
                    <span>à partir de</span>
                    <p>200€</p>
                ...
                <div class="list">
                    <div class="elem">
                        <img src="{{asset('images/svg/check-yellow.svg')}}" alt="Check icon">
                        <p>Développement PHP, NodeJS</p>
                    </div>
                    <div class="elem">
                        <img src="{{asset('images/svg/check-yellow.svg')}}" alt="Check icon">
                        <p>Solution Laravel</p>
                    </div>
                </div>
                <a href="#devis">
                    <div class="devis">
