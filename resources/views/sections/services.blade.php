    ...
    <div>
        ...
        <div class="pr-ct col-lg-10 col-xl-8 offset-lg-1 offset-xl-2">
            ...
            <div class="pr" itemscope itemtype="https://schema.org/Service">
                ...
                <p itemprop="description">Nous vous offrons notre savoir-faire dans le développement web avec des langages tel que HTML, CSS, JAVASCRIPT.</p>
            </div>
            <div class="pr" itemscope itemtype="https://schema.org/Service">
                <img itemprop="logo" src="{{asset('images/pres/web.png')}}" alt="Web">
                <h3 itemprop="category">Référencement</h3>
                <p itemprop="description">Nous nous occupons de référencer votre site internet sur les moteurs de recherches en les enregistrant.</p>
            </div>
        </div>
